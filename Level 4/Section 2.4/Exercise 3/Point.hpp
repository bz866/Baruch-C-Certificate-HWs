...
public:
	...
	// Point(double val); // the constructor is implicitly used as conversion operator
	explicit Point(double val); // prevent using the constructor as the conversion operator
